...
//     // Simulate page load delay with spinner
//     setTimeout(() => {
//       // Preloaded discussions
//       setDiscussions([
//         {
...
//   const handleJoinDiscussionClick = () => {
...
//                 data-aos="zoom-in"
//                 data-aos-delay="300"
//                 className="card bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% text-primary-content p-2"
//               >
//                 <div className="card-body">
//                   <h2
//                     data-aos="slide-right"
//                     className="text-3xl font-bold text-blue-500 card-title"
//                   >
//                     {discussion.title}
//                   </h2>
//                   <p
...
//                     <button
//                       onClick={handleJoinDiscussionClick}
//                       data-aos="fade-up"
//                       data-aos-delay="600"
//                       className="text-white bg-blue-900 border-none btn"
//                     >
//                       Join Discussions
//                     </button>
//                   </div>
